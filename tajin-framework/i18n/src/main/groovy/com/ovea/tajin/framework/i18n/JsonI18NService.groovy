...
class JsonI18NService implements I18NService {
    ...
    private final ConcurrentMap<String, JsonI18NBundlerProvider> providers = new ConcurrentHashMap<String, JsonI18NBundlerProvider>();
    ...
    public I18NBundlerProvider getBundleProvider(String bundleName) {
        ...
        JsonI18NBundlerProvider service = providers.get(bundleName);
        if (service == null) {
            providers.putIfAbsent(bundleName, new JsonI18NBundlerProvider(bundleName));
