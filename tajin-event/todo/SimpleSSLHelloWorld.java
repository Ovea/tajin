 ...
 *  
 * @author F�bio Matos (fabiomatos@gmail.com)
 */
public class SimpleSSLHelloWorld implements Container {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        SimpleSSLHelloWorld.serverPort = 8443;
        // System.setProperty("javax.net.debug", "all");
        System.setProperty(SimpleSSLHelloWorld.KEYSTORE_PROPERTY, "C:\\keystores\\server.keystore");
        System.setProperty(SimpleSSLHelloWorld.KEYSTORE_PASSWORD_PROPERTY, "serverpassword");
